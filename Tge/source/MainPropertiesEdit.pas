...
uses
  ...
  ParameterDeltaClass,
  MessageText,
  ExtCtrls, EC_BlockPar, Gauges, Tabs;
...
type
  TForm4 = class(TForm)
    ...
    Label13: TLabel;
    ParEnabledCB1: TCheckBox;
    ParEnabledCB2: TCheckBox;
    ParEnabledCB3: TCheckBox;
    ParEnabledCB4: TCheckBox;
    ParEnabledCB5: TCheckBox;
    ParEnabledCB6: TCheckBox;
    ParEnabledCB9: TCheckBox;
    ParEnabledCB8: TCheckBox;
    ParEnabledCB7: TCheckBox;
    Shape1: TShape;
    Shape2: TShape;
    ...
    ParEnabledCB12: TCheckBox;
    ParEnabledCB11: TCheckBox;
    ParEnabledCB10: TCheckBox;
    ...
    ParEnabledCB13: TCheckBox;
    ParEnabledCB14: TCheckBox;
    ParEnabledCB15: TCheckBox;
    ParEnabledCB16: TCheckBox;
    ParEnabledCB17: TCheckBox;
    ParEnabledCB18: TCheckBox;
    ParEnabledCB21: TCheckBox;
    ParEnabledCB20: TCheckBox;
    ParEnabledCB19: TCheckBox;
    ParRadioButton22: TRadioButton;
    ParRadioButton23: TRadioButton;
    ParRadioButton24: TRadioButton;
    ParEnabledCB24: TCheckBox;
    ParEnabledCB23: TCheckBox;
    ParEnabledCB22: TCheckBox;
    ParTabSet: TTabSet;
    CL1: TLabel;
    CL4: TLabel;
    CL3: TLabel;
    ...
    procedure ParRadioButton1MouseUp(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton2MouseUp(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton3MouseUp(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton4MouseUp(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton5MouseUp(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton6MouseUp(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton7MouseUp(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton8MouseUp(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton9MouseUp(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    ...
    procedure VFValTrackBarGroundShapeMouseMove(Sender: TObject;
      Shift: TShiftState; X, Y: Integer);
    procedure VFValTrackBarGroundShapeMouseDown(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure VFValTrackBarLeftImageMouseDown(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure VFValTrackBarRightImageMouseDown(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure VFValTrackBarLeftImageMouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure VFValTrackBarRightImageMouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    ...
    procedure ParRadioButton10MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton11MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton12MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    ...
    procedure ParRadioButton13MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton14MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton15MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton16MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton17MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton18MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton19MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton20MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton21MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton22MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton23MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure ParRadioButton24MouseUp(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
...
begin
        ...
        if SelectedParameter<>0 then begin
           ...
           ShowParVF;
            ...
            if not hidden
                          then ParViewActionRG.ItemIndex:=0
...
ParVolVFStringsTrackBar.max:=GetAvailDiapasones;
Label12.Caption:=inttostr(ParVolVFStringsTrackBar.Max);
if ParVolVFStringsTrackBar.max>ParVolVFStringsTrackBar.position
  then  begin
...
procedure TForm4.ParRadioButton1MouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TForm4.ParRadioButton2MouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TForm4.ParRadioButton3MouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TForm4.ParRadioButton4MouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
if ssLeft in Shift then begin
   ...
   dmax:=ParVolVFStringsTrackBar.Max;
     ...
     currentposition:=
       round(dmax*(X)/VFValTrackBarGroundShape.Width);
...
ParVolVFStringsTrackBar.Position:=
    ParVolVFStringsTrackBar.Position-1;
...
procedure TForm4.VFValTrackBarRightImageMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
if ParVolVFStringsTrackBar.position
    <
   ParVolVFStringsTrackBar.max then
...
ParDeltaTrackBar.Position:=
    ParDeltaTrackBar.Position-1;
end;

procedure TForm4.TrackBarRightImageMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
if ParDeltaTrackBar.position
    <
   ParDeltaTrackBar.max then
...
procedure TForm4.TrackBarLeftImageMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
RedrawParDeltaTrackBar;
...
procedure TForm4.TrackBarRightImageMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
RedrawParDeltaTrackBar;
...
procedure TForm4.TrackBarGroundShapeMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TForm4.ParRadioButton10MouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TForm4.ParRadioButton11MouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TForm4.ParRadioButton12MouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TForm4.ParTabSetChange(Sender: TObject; NewTab: Integer;
  var AllowChange: Boolean);
begin
