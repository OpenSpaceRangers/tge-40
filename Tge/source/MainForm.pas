...
var lx,ly:integer; //px,py,px1,py1:integer;
    i,c,q:integer;
    tempPath:TPath;
...
begin
  ...
  if (i<=0) and (c<=0) then begin
       ...
       if (sqrt(sqr(lx-MouseDownCoords.x)+sqr(ly-MouseDownCoords.y))
           <
           Game.GetPathDistance(c,MouseDownCoords.x,MouseDownCoords.y))
        then begin
     ...
     //  tempgame.CopyDataFrom(Game);
       ...
       end else begin Game.Locations[i].CopyDataFrom(TempLocation);
                TraceForClosedLocations;
                NiceRepaint;
                end;
