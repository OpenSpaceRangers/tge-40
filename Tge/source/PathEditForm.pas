...
begin
	...
	for i:=1 to Form2.Game.PathesValue do begin
		if (Form2.Game.Pathes[i].FromLocation=Form2.Game.Pathes[QuestPathIndex].FromLocation)
        	and
           (trim(Form2.Game.Pathes[i].StartPathMessage.Text)=trim(Form2.Game.Pathes[QuestPathIndex].StartPathMessage.Text)) then begin
...
begin
        ...
        if trim(FormPath.EndPathMessage.text)=''
                                            then FormPath.VoidPathFlag:=true
...
procedure TForm3.TrackBarRightImageMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var dmax:integer;
begin
...
procedure TForm3.TrackBarLeftImageMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
DrawStatistics;
end;

procedure TForm3.TrackBarRightImageMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
DrawStatistics;
end;
...
procedure TForm3.ParTabSetChange(Sender: TObject; NewTab: Integer;
  var AllowChange: Boolean);
begin
