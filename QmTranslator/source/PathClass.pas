...
procedure TPath.InitMessagePointers(var MessagesValue:integer;var MessageTypes:AInt;var MessagePointers:APWS);
var i:integer;
begin

     if trim(StartPathMessage.Text)<>'' then begin
        inc(MessagesValue);
        MessageTypes[MessagesValue]:=PathQuestionMSGType;
        MessagePointers[MessagesValue]:=@StartPathMessage.Text;
     end;

     if trim(EndPathMessage.Text)<>'' then begin
        inc(MessagesValue);
        MessageTypes[MessagesValue]:=PathTextMSGType;
        MessagePointers[MessagesValue]:=@EndPathMessage.Text;
     end;
